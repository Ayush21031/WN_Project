...
def main():
    ...
    ipv4_address = "163.70.145.35"  # Google Public DNS IPv4
    ipv6_address = "2a03:2880:f18a:8a:face:b00c:0:25de"  # Google Public DNS IPv6
    ...
    if os_type == "Windows":
        ...
        traceroute_cmd_ipv4 = ["traceroute", ipv4_address]
        traceroute_cmd_ipv6 = ["traceroute6", ipv6_address]
